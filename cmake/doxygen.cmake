...
# AUDIOLIB_DOXYGEN_XML, which this target sets to the absolute XML output dir
...
if(DOXYGEN_FOUND AND SPHINX_BUILD_EXECUTABLE)
  ...
  # Absolute XML dir passed to sphinx-build via env var AUDIOLIB_DOXYGEN_XML
  ...
  add_custom_target(
    ...
    COMMAND ${CMAKE_COMMAND} -E env
              AUDIOLIB_DOXYGEN_XML=${DOXYGEN_XML_DIR}
