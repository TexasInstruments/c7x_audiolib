...
#ifndef COMMON_AUDIOLIB_UTIL_Q_SE1BLOAD_H_
#define COMMON_AUDIOLIB_UTIL_Q_SE1BLOAD_H_ 1

/******************************************************************************/
#ifdef C7X
/******************************************************************************/
/*!
 * \ingroup audiolib_util_q
 ...
 */
/******************************************************************************/
__INLINE_FUNC(AUDIOLIB_UTIL_Q_SE1Bload)
template <uint32_t UNROLL_FACTOR> static inline void AUDIOLIB_UTIL_Q_SE1Bload(int32_t numRows, c7x::float_vec vQFactor)
{
   _nassert(numRows > 0);
...
#endif /* COMMON_AUDIOLIB_UTIL_Q_SE1BLOAD_H_ */
