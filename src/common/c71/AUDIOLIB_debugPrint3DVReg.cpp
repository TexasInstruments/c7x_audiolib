...
template <typename dataType>
void AUDIOLIB_debugPrint3DVReg_helperU(dataType *matrix, const AUDIOLIB_bufParams3D_t *params)
{
   uint32_t  r, c, t;
   dataType *xPtr;
   dataType *yPtr;
...
template void AUDIOLIB_debugPrint3DVReg_helperU<uint16_t>(uint16_t *matrix, const AUDIOLIB_bufParams3D_t *params);
...
void AUDIOLIB_debugPrint3DVReg(void *matrix, const AUDIOLIB_bufParams3D_t *params)
{
   ...
   case AUDIOLIB_UINT16:
      AUDIOLIB_debugPrint3DVReg_helperU<uint16_t>((uint16_t *) matrix, params);
      break;
   case AUDIOLIB_INT8:
