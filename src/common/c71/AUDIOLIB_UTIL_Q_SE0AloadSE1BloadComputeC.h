...
#ifndef COMMON_AUDIOLIB_UTIL_Q_SE0ALOADSE1BLOADCOMPUTEC_H_
#define COMMON_AUDIOLIB_UTIL_Q_SE0ALOADSE1BLOADCOMPUTEC_H_ 1
...
/******************************************************************************/
#ifdef C7X
__INLINE_FUNC(AUDIOLIB_UTIL_Q_SE0AloadSE1BloadComputeC)
template <uint32_t UNROLL_FACTOR>
static inline void AUDIOLIB_UTIL_Q_SE0AloadSE1BloadComputeC(int32_t numRows, c7x::float_vec vQFactor)
{
...
#endif // COMMON_AUDIOLIB_UTIL_Q_SE0ALOADSE1BLOADCOMPUTEC_H_
