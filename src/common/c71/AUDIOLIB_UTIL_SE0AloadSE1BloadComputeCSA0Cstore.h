...
#ifndef COMMON_AUDIOLIB_UTIL_SE0ALOADSE1BLOADCOMPUTECSA0CSTORE_H_
#define COMMON_AUDIOLIB_UTIL_SE0ALOADSE1BLOADCOMPUTECSA0CSTORE_H_ 1
...
/******************************************************************************/
#ifdef C7X
__INLINE_FUNC(AUDIOLIB_UTIL_SE0AloadSE1BloadComputeCSA0Cstore)
template <typename dataType, uint32_t UNROLL_FACTOR>
static inline void AUDIOLIB_UTIL_SE0AloadSE1BloadComputeCSA0Cstore(int32_t numRows, dataType *cBackDst)
{
...
#endif
#endif // COMMON_AUDIOLIB_UTIL_SE0ALOADSE1BLOADCOMPUTECSA0CSTORE_H_
