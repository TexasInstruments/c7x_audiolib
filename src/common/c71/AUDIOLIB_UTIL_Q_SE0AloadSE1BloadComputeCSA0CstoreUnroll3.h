...
#ifndef COMMON_AUDIOLIB_UTIL_Q_SE0ALOADSE1BLOADCOMPUTECSA0CSTORE_H_
#define COMMON_AUDIOLIB_UTIL_Q_SE0ALOADSE1BLOADCOMPUTECSA0CSTORE_H_ 1
...
__INLINE_FUNC(AUDIOLIB_UTIL_Q_SE0AloadSE1BloadComputeCSA0CstoreUnroll3)
static inline void
AUDIOLIB_UTIL_Q_SE0AloadSE1BloadComputeCSA0CstoreUnroll3(int32_t numRows, c7x::float_vec vQFactor, float *cBackDst)
{
   ...
   int32_t numRowsUnroll = AUDIOLIB_ceilingDiv(numRows, 3);
   ...
   for (r = 0; r < numRowsUnroll; r++) {
      ...
      c7x::float_vec VB0sp_0   = __int_to_float(c7x::reinterpret<c7x::int_vec>(VB0_0));
      ...
      __vstore_pred(pred_0, VB1_0, c7x::reinterpret<c7x::float_vec>(vResult_0));
      ...
      c7x::float_vec VB0sp_1   = __int_to_float(c7x::reinterpret<c7x::int_vec>(VB0_1));
      ...
      __vstore_pred(pred_1, VB1_1, c7x::reinterpret<c7x::float_vec>(vResult_1));
      ...
      c7x::float_vec VB0sp_2   = __int_to_float(c7x::reinterpret<c7x::int_vec>(VB0_2));
      ...
      __vstore_pred(pred_2, VB1_2, c7x::reinterpret<c7x::float_vec>(vResult_2));
   }

   return;
}
#endif
#endif // COMMON_AUDIOLIB_UTIL_Q_SE0ALOADSE1BLOADCOMPUTECSA0CSTORE_H_
