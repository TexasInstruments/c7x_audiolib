...
const __HWA_CONFIG_REG_v1 configRegisterStruct_i32s_i32s_o32s = {
    ...
    ASSIGN(B_BSWPER, AUDIOLIB_MMA_SIZE_32_BIT),  // 32 bits
    ASSIGN(B_BRSTPER, AUDIOLIB_MMA_SIZE_32_BIT), // 8 bits
    ...
    ASSIGN(C_OP0PER, AUDIOLIB_MMA_SIZE_32_BIT),           // Operation 0 period
    ASSIGN(C_BSWPER, AUDIOLIB_MMA_SIZE_32_BIT),           // B bank switch period
    ...
    ASSIGN(C_CRRSTPER, AUDIOLIB_MMA_SIZE_32_BIT),         // C read row offset reset period
    ASSIGN(C_CWRSTPER, AUDIOLIB_MMA_SIZE_32_BIT),         // C write row offset reset period for computations
    ...
    ASSIGN(X_SAT_MAX_8_4, 0), ASSIGN(X_CSWPER, AUDIOLIB_MMA_SIZE_32_BIT), // C read bank switch period
    ASSIGN(X_CRRSTPER, AUDIOLIB_MMA_SIZE_32_BIT),                         // C read row offset reset period
...
const __HWA_CONFIG_REG_v1 configRegisterStruct_i16s_i16s_o16s = {
    ...
    ASSIGN(B_BSWPER, AUDIOLIB_MMA_SIZE_16_BIT),  // 32 bits
    ASSIGN(B_BRSTPER, AUDIOLIB_MMA_SIZE_16_BIT), // 8 bits
    ...
    ASSIGN(C_CLRSTPER, 0),                                // C write row offset reset period for HWALD*
    ASSIGN(C_OP1PER, 0),                                  // Operation 1 period
    ASSIGN(C_OP0PER, AUDIOLIB_MMA_SIZE_16_BIT),           // Operation 0 period
    ASSIGN(C_BSWPER, AUDIOLIB_MMA_SIZE_16_BIT),           // B bank switch period
    ASSIGN(C_CRSWPER, 0),                                 // C bank switch period for read instructions
    ASSIGN(C_CWSWPER, 0),                                 // C bank switch period for computation writes
    ASSIGN(C_CRRSTPER, AUDIOLIB_MMA_SIZE_16_BIT),         // C read row offset reset period
    ASSIGN(C_CWRSTPER, AUDIOLIB_MMA_SIZE_16_BIT),         // C write row offset reset period for computations
    ...
    ASSIGN(X_SAT_MAX_8_4, 0), ASSIGN(X_CSWPER, AUDIOLIB_MMA_SIZE_16_BIT), // C read bank switch period
    ASSIGN(X_CRRSTPER, AUDIOLIB_MMA_SIZE_16_BIT),                         // C read row offset reset period
    ASSIGN(X_COFFSET, 0x0),                                               // C matrix row read address offset
    ASSIGN(X_CSTART, 0x0),                                                // Initial C bank selection
    ASSIGN(X_SAT_MAX_15_9, 0),
...
const __HWA_CONFIG_REG_v1 configRegisterStruct_i16u_i16u_o16u = {
    ...
    ASSIGN(C_LOP1, __MMA_C_CONFIG_LOP_C), ASSIGN(C_BIASORDER, __MMA_C_CONFIG_BIAS_ORDER_COLUMN), ASSIGN(C_RSVD4, 0),
    ASSIGN(C_HWLDDST, __MMA_C_CONFIG_HWLDDST_X4_0), ASSIGN(C_RSVD5, 0),
    ASSIGN(C_HWLDTYPE, __MMA_C_CONFIG_HWLDTYPE_UINT16), ASSIGN(C_RSVD6, 0),
    ASSIGN(C_OPSTART, __MMA_C_CONFIG_OPSTART_OPERATION0), // No enum in MMA spec? Initial C operand selections
    ASSIGN(C_BSTART, 0x0),                                // Initial B bank selection for reading B matrix data
    ASSIGN(C_CRSTART, 0x0),                               // Initial C bank selection for reading operands
    ASSIGN(C_CWSTART, 0x0),                               // Initial C bank selection for writing computation results
    ...
    ASSIGN(X_SAT_MAX_3_0, 0),
    ASSIGN(X_CTYPE,
           __MMA_X_CONFIG_CTYPE_UINT64), // C matrix element typeASSIGN(  This must be consistent with the B FSM setting
    ASSIGN(X_SAT_MAX_8_4, 0), ASSIGN(X_CSWPER, AUDIOLIB_MMA_SIZE_16_BIT), // C read bank switch period
    ASSIGN(X_CRRSTPER, AUDIOLIB_MMA_SIZE_16_BIT),                         // C read row offset reset period
    ASSIGN(X_COFFSET, 0x0),                                               // C matrix row read address offset
    ASSIGN(X_CSTART, 0x0),                                                // Initial C bank selection
...
const __HWA_CONFIG_REG_v1 configRegisterStruct_i8s_i8s_o8s = {
    ...
    ASSIGN(B_BSWPER, AUDIOLIB_MMA_SIZE_8_BIT),  // 32 bits
    ASSIGN(B_BRSTPER, AUDIOLIB_MMA_SIZE_8_BIT), // 8 bits
    ...
    ASSIGN(C_CLRSTPER, 0),                                // C write row offset reset period for HWALD*
    ASSIGN(C_OP1PER, 0),                                  // Operation 1 period
    ASSIGN(C_OP0PER, AUDIOLIB_MMA_SIZE_8_BIT),            // Operation 0 period
    ASSIGN(C_BSWPER, AUDIOLIB_MMA_SIZE_8_BIT),            // B bank switch period
    ASSIGN(C_CRSWPER, 0),                                 // C bank switch period for read instructions
    ASSIGN(C_CWSWPER, 0),                                 // C bank switch period for computation writes
    ASSIGN(C_CRRSTPER, AUDIOLIB_MMA_SIZE_8_BIT),          // C read row offset reset period
    ASSIGN(C_CWRSTPER, AUDIOLIB_MMA_SIZE_8_BIT),          // C write row offset reset period for computations
    ...
    ASSIGN(X_SAT_MAX_8_4, 0), ASSIGN(X_CSWPER, AUDIOLIB_MMA_SIZE_8_BIT), // C read bank switch period
    ASSIGN(X_CRRSTPER, AUDIOLIB_MMA_SIZE_8_BIT),                         // C read row offset reset period
    ASSIGN(X_COFFSET, 0x0),                                              // C matrix row read address offset
    ASSIGN(X_CSTART, 0x0),                                               // Initial C bank selection
    ASSIGN(X_SAT_MAX_15_9, 0),
...
const __HWA_CONFIG_REG_v1 configRegisterStruct_i8s_i8u_o8s = {
    ...
    ASSIGN(A_ARF_BASE, 0),                                              /* disable A register file */
    ASSIGN(A_RSVD3, 0), ASSIGN(A_ARF_SIZE, 64),                    /* ARF array size for read and write operations  */
    ASSIGN(A_RSVD4, 0), ASSIGN(B_BSWPER, AUDIOLIB_MMA_SIZE_8_BIT), // 32 bits
    ASSIGN(B_BRSTPER, AUDIOLIB_MMA_SIZE_8_BIT),                    // 8 bits
    ASSIGN(B_BTYPE, __MMA_B_CONFIG_SIZE8),                         // 2 bits
    ASSIGN(B_LDBOPT, __MMA_LDBOPT_MMA1),                           /* Control for enhanced B operand row loading    */
    ASSIGN(B_B4EXP, __MMA_B_CONFIG_B4EXP_MMA1), /* B operand expansion control to conv 4-bit ops to 8-bit ops */
