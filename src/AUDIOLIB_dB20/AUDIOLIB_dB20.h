...
#ifndef AUDIOLIB_DB20_IXX_IXX_OXX_H_
#define AUDIOLIB_DB20_IXX_IXX_OXX_H_
...
/**
 * @defgroup AUDIOLIB_dB20 AUDIOLIB_dB20
 * @brief  Kernel for computing the elementwise base-10 logarithm of an input vector, scaled by a factor of 20.
 * @details
 ...
 *               @ref AUDIOLIB_dB20_init function. This function
 *               is called with the same parameters as the
 *               @ref AUDIOLIB_dB20_init, and this function
 *               must be called before the
 *               @ref AUDIOLIB_dB20_init is called.
 *
 ...
 *               @ref AUDIOLIB_dB20_exec function is called. This
...
/**
 *  @brief       This function checks the validity of the parameters passed to
 *               @ref AUDIOLIB_dB20_exec function. This function
 *               is called with the same parameters as the
 *               @ref AUDIOLIB_dB20_exec, and this function
 *               must be called before the
 *               @ref AUDIOLIB_dB20_exec is called.
 *
 *  @param [in]  handle       :  Active handle to the kernel
...
#endif /* AUDIOLIB_DB20_IXX_IXX_OXX_H_ */
