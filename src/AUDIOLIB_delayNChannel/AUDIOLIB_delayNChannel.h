...
#ifndef AUDIOLIB_DELAYNCHANNEL_IXX_IXX_OXX_H_
#define AUDIOLIB_DELAYNCHANNEL_IXX_IXX_OXX_H_
...
/**
 * @defgroup AUDIOLIB_delayNChannel AUDIOLIB_delayNChannel
 * @brief Kernel for multichannel delay apply
 *
 * @details
 *          - Kernel for applying multiple delay on multiple channels
 *          - Kernel supports both linear and circular delay
 *          - Kernel supports a maximum of 64 channels
 *          - Kernel supports both interleaved and de-interleaved input
 *
 *
 * @ingroup  AUDIOLIB
 */
 ...
 *               @ref AUDIOLIB_delayNChannel_exec function is called. This
 ...
 *               @ref AUDIOLIB_delayNChannel_init function. This function
 *               is called with the same parameters as the
 *               @ref AUDIOLIB_delayNChannel_init, and this function
 *               must be called before the
 *               @ref AUDIOLIB_delayNChannel_init is called.
 *
 *  @param [in]  handle         :  Active handle to the kernel
 *  @param [in]  bufParamsIn    :  Pointer to the structure containing dimensional
 *                                 information of input buffer
...
/**
 *  @brief       This function checks the validity of the parameters passed to
 *               @ref AUDIOLIB_delayNChannel_exec function. This function
 *               is called with the same parameters as the
 *               @ref AUDIOLIB_delayNChannel_exec, and this function
 *               must be called before the
 *               @ref AUDIOLIB_delayNChannel_exec is called.
 *
 *  @param [in]  handle      :  Active handle to the kernel
 *  @param [in]  pIn         :  Pointer to the input buffer
 *  @param [in]  pDelay      :  Pointer to the input delay buffer
 ...
 *               @ref AUDIOLIB_delayNChannel_exec
 *
 *  @param [in]  handle      : Active handle to the kernel
 *  @param [in]  pIn         : Pointer to buffer holding the input buffer
 *  @param [in]  pDelay      : Pointer to buffer holding the input delay
 ...
 *               @ref AUDIOLIB_delayNChannel_init and
...
#endif /* AUDIOLIB_DELAYNCHANNEL_IXX_IXX_OXX_H_ */
