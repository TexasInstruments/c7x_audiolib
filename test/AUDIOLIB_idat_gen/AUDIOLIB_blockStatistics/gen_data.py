...
def gen_testCaseParams(testParamsFile, currPrm):
    ...
    testParamsFile.write("%s, // Input buffer\n" % ((in0)))
    testParamsFile.write("%s, // Output buffer \n" % ((out)))
    testParamsFile.write("%s, // inputBlockSize \n" % ((inSamples)))
    testParamsFile.write("%s, // numChannels \n" % ((inChannels)))
    testParamsFile.write("%s, // statisticsType \n" % ((statisticsType)))
    testParamsFile.write(
...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "AUDIOLIB_blockStatistics_idat.h"'
    ...
    idatFile.write("static AUDIOLIB_blockStatistics_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    # Create an instance of AUDIOLIB_blockStatistics
    blockStats = AUDIOLIB_blockStatistics(
    ...
    outputSignal = blockStats.exec(inputSignal)
...
# Main processing
testCasesCsvFile = "../AUDIOLIB_blockStatistics/test_cases_list.csv"
...
idatFileName = "../../AUDIOLIB_blockStatistics/AUDIOLIB_blockStatistics_idat.c"
