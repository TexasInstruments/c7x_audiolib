...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "AUDIOLIB_dB20_idat.h"'
    ...
    idatFile.write("static AUDIOLIB_dB20_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    # Create an instance of AUDIOLIB_dB20
    db20 = AUDIOLIB_dB20(
...
idatFileName = "../../AUDIOLIB_dB20/AUDIOLIB_dB20_idat.c"
