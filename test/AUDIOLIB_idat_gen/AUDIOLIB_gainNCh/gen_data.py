...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "AUDIOLIB_gainNCh_idat.h"'
    ...
    idatFile.write("static AUDIOLIB_gainNCh_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    # Create an instance of AUDIOLIB_gainNCh
    gainNCh_processor = AUDIOLIB_gainNCh(
        dType=dType,
    ...
    # Execute the gainNCh algorithm using the class
    out = gainNCh_processor.exec(in0, in1)
...
testCasesCsvFile = "../AUDIOLIB_gainNCh/test_cases_list.csv"
...
idatFileName = "../../AUDIOLIB_gainNCh/AUDIOLIB_gainNCh_idat.c"
