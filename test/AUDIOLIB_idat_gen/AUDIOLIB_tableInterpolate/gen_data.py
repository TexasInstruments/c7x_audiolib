...
from process import tableInterpolateProcess
...
def gen_testCaseParams(testParamsFile, currPrm):
    ...
    tableInterpolateSize = currPrm["tableInterpolateSize"]
    ...
    idatFile.write("%s, // tableInterpolateSize \n" % (tableInterpolateSize))
...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "AUDIOLIB_tableInterpolate_idat.h"'
    ...
    idatFile.write("static AUDIOLIB_tableInterpolate_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    dst = tableInterpolateProcess(src, table, minVal, maxVal, tableSamples)
...
testCasesCsvFile = "../AUDIOLIB_tableInterpolate/test_cases_list.csv"
...
idatFileName = "../../AUDIOLIB_tableInterpolate/AUDIOLIB_tableInterpolate_idat.c"
