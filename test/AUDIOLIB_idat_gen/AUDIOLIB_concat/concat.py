...
This module provides the core concatenation functionality for combining
...
def concat_aggregator(
    ...
    Example:
        ...
        >>> output = concat_aggregator([input1, input2], is_input_interleave=False, is_output_interleave=False)
