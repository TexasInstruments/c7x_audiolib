...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "AUDIOLIB_undB20_idat.h"'
    ...
    idatFile.write("static AUDIOLIB_undB20_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    # Create an instance of AUDIOLIB_undB20
    undb20 = AUDIOLIB_undB20(
...
idatFileName = "../../AUDIOLIB_undB20/AUDIOLIB_undB20_idat.c"
