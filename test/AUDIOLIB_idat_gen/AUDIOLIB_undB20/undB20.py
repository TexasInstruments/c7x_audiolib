...
class AUDIOLIB_undB20:
    def __init__(self, dType="float", inChannels=1, inSamples=1, minX=0.0, maxX=1.0):
        """Initialize the AUDIOLIB_undB20 class with private members.
    ...
    def exec(self, in0):
        """Execute the undB20 algorithm.

        Args:
            in0 (numpy.ndarray): Input buffer of shape (inChannels, inSamples) or flattened.

        Returns:
            numpy.ndarray: Output buffer with undB20 conversion applied.
        """
