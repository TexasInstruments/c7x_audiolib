...
class AUDIOLIB_gainNChTrim:
    def __init__(self, dType="float", inChannels=1, inSamples=1, isInterleave=0):
        """Initialize the AUDIOLIB_gainNChTrim class with private members.
    ...
    def exec(self, in0, in1, masterGain):
        """Execute the gainNChTrim algorithm.
        ...
        Args:
            ...
            in1 (numpy.ndarray): Channel gain values, shape (inChannels,).
            masterGain (float): Master gain value to apply to all channels.
        ...
        if not self._isInterleave:
            ...
            # For interleaved format, apply gain
            out = in0 * in1
            # Apply master gain to all channels
            out = out * masterGain
