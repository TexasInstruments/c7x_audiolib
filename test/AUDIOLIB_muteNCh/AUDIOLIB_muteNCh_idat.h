...
#ifndef AUDIOLIB_MUTENCH_IXX_IXX_OXX_IDAT_H

#define AUDIOLIB_MUTENCH_IXX_IXX_OXX_IDAT_H
...
} AUDIOLIB_muteNCh_testParams_t;

void AUDIOLIB_muteNCh_getTestParams(AUDIOLIB_muteNCh_testParams_t **params, int32_t *numTests);

#endif /* define AUDIOLIB_MUTENCH_IXX_IXX_OXX_IDAT_H */
