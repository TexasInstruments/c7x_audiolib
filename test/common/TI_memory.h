...
#if SOC == j721e
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 4 * 1024 * 1024
#elif SOC == j721s2
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 3 * 1024 * 1024
#elif SOC == j784s4
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 2 * 1024 * 1024
#elif SOC == AM62A
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 800 * 1024 // 800 Kbytes to start with out of 1 MB in EL2, sect2
#define AUDIOLIB_L2_BUFFER_SIZE 256 * 1024         // 800 Kbytes to start with out of 1 MB in EL2, sect2
#elif SOC == AM62D
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 800 * 1024 // 800 Kbytes to start with out of 1 MB in EL2, sect2
#define AUDIOLIB_L2_BUFFER_SIZE 256 * 1024         // 800 Kbytes to start with out of 1 MB in EL2, sect2
#elif SOC == j722s
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 800 * 1024 // 800 Kbytes to start with out of 1 MB in EL2, sect2
#define AUDIOLIB_L2_BUFFER_SIZE 256 * 1024
#elif SOC == AM275
#define AUDIOLIB_L3_RESULTS_BUFFER_SIZE 800 * 1024 // 800 Kbytes to start with out of 1 MB in EL2, sect2
#define AUDIOLIB_L2_BUFFER_SIZE 256 * 1024         // 800 Kbytes to start with out of 1 MB in EL2, sect2
#else
